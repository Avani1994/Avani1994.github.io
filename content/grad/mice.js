document.write(`
<div id="open-other" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Contribution to other code bases</h4>
      </div>
      <div class="modal-body">
      Here we are dealt with mice temperature data from Psychology Department at University of California Berkeley . 
      ...
      <a href='https://github.com/search?utf8=%E2%9C%93&q=author%3AAkarshit&type=' target="_blank"> here </a>
      </div>
